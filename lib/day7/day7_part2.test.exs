defmodule Day7.Part2Test do
  ...
  alias Day7.Part2, as: Subject

  test "type_points" do
    assert 2 == Subject.type_points("32T3K")
    assert 6 == Subject.type_points("T55J5")
    assert 3 == Subject.type_points("KK677")
    assert 6 == Subject.type_points("KTJJT")
    assert 6 == Subject.type_points("QQQJA")
  ...
  test "sort_hands_asc" do
    ...
    assert [
             ...
             %{cards: "T55J5", type_points: 6, bid: 684},
             %{cards: "QQQJA", type_points: 6, bid: 483},
             %{cards: "KTJJT", type_points: 6, bid: 220}
